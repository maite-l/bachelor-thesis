    ...
    return (
        <div className={styles.chatbotHeader}>
            <div className={styles.characterContainer}>
                <img className={styles.character} src={`/images/chatheader/${slug}.gif`} alt={data.characterName} />
            </div>
            <div className={styles.chatbotHeaderInfo}>
                <h1 className={styles.chatbotName}>{data.characterName}</h1>
                {data.quote && (
                    <p className={styles.chatbotQuote}>{data.quote}</p>
                )}
                {data.eventName && data.location && (
